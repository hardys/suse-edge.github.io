...
* The Edge Image Builder image has been rebuilt to include the updated MetalLB release mentioned above
...
* The update to RKE2 1.31.7 includes several CVE fixes impacting the ingress-nginx component https://www.suse.com/support/kb/doc/?id=000021756[KnowledgeBase Article]
...
s| Edge Image Builder | 1.1.0 | N/A s| registry.suse.com/edge/3.2/edge-image-builder:1.1.0.1
