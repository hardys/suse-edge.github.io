...
* Management cluster upgrades are now managed via a new Upgrade Controller
* Edge Image Builder now supports aarch64 (tech preview)
* Stack Validation results are now published at: https://ci.edge.suse.com
* nm-configurator updated to utilize nmstate 2.2.38
