...
* Management cluster upgrades are now managed via <<components-upgrade-controller, Upgrade Controller>>
* Stack Validation results are now published at link:https://ci.edge.suse.com[ci.edge.suse.com]
